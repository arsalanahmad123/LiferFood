...
const EditProduct = () => {
    ...
    const [productVaraintID, setProductVaraintID] = useState(null)
    ...
    const updateProduct = async (e) => {
        ...
        try {
            setCreating(!create)
            const response = await resturantApi.put(`/products/${id}`, {
    ...
    useEffect(() => {
        ...
        const fetchProduct = async () => {
            ...
            setSelectedVariants(response.data.data.ProductVariants)
            setFinalVariant(response.data.data.ProductVariants)
        }
                ...
                >
                    <div className='md:col-span-6 col-span-12 flex flex-col justify-start items-start gap-y-5'>
                        <div className='flex flex-row text-gray-700 gap-x-5 justify-center items-center font-medium'>
                            ...
                            />
                            <h3 className='text-2xl '>Edit Menu Item</h3>
                        </div>
